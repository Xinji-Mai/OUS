...
checkpoint = torch.load("/home/et23-maixj/mxj/JMPF_state/checkpoint/baseline_39K2.ckpt", map_location = device) # 这里假设您的checkpoint文件名是best-checkpoint.ckpt，您可以根据您的实际文件名来修改
